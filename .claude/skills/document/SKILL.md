---
name: document
description: 구현된 코드를 분석하여 포괄적인 기술 문서를 작성합니다. 프로젝트 문서화 시 활용하세요.
...
구현된 코드를 분석하여 사용자와 개발자를 위한 포괄적인 문서를 작성합니다.
...
간단한 언어를 사용하고 기술 용어는 설명과 함께 제시합니다. 예제를 포함하여 이해도를 높입니다.

### 2. 완전성 (Completeness)

모든 기능과 API 엔드포인트를 문서화하고 에러 케이스도 포함합니다.

### 3. 최신성 (Currency)

코드와 동기화를 유지하고 정기적으로 업데이트하며 변경 로그를 유지합니다.

### 4. 접근성 (Accessibility)

검색 가능한 구조를 제공하고 목차를 포함하며 링크를 활용합니다.
